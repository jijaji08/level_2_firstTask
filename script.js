...
let input_events_handle=()=>{
    ...
    search_input.addEventListener("input",(obj)=>{
        // console.log(search_input.value,);
        let newarr=arr.filter(function(val){ //val is taking hole object({})
            return val.name.toLowerCase().startsWith(search_input.value);
        })
        let clutter=""
